...
export function VerifiedBadge({
  ...
  return (
    ...
    >
      {/* Eight-lobe scalloped seal. The surface-colored stroke
          separates the seal from whatever it sits on — invisible
          at small sizes (next to text), but lifts the seal off a
          colored avatar at large sizes. */}
      <path
        fill="hsl(var(--ink))"
